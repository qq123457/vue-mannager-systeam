(function () {
  ...
  var e = {
      6298: function (e, t, n) {
        var r = n(9242),
          o = n(6265),
          i = n.n(o);
        (i().defaults.baseURL = "https://httpbin.org"),
          (i().defaults.timeout = 1e5),
          i().interceptors.request.use(
            (e) => (console.log("请求拦截成功"), e),
            (e) => (console.log("请求发生错误"), e)
          ),
          i().interceptors.response.use(
            (e) => (console.log("响应拦截成功"), e),
            (e) => (console.log("服务器响应失败"), e)
          ),
          i()
            .all([
              i().get("/get", { params: { name: "acwink" } }),
              i().post("/post", { data: { name: "acwink" } })
            ])
            .then((e) => {
              console.log(e);
            });
        ...
        function l(e, t, n, r, o, i) {
          const l = (0, u.up)("router-link"),
            d = (0, u.up)("router-view");
          return (
            (0, u.wg)(),
            (0, u.iD)("div", c, [
              (0, u._)("h2", null, (0, a.zw)(e.$store.state.name), 1),
              (0, u.Wm)(
                l,
                { to: "/login" },
                { default: (0, u.w5)(() => [s]), _: 1 }
              ),
              (0, u.Wm)(
                l,
                { to: "/main" },
                { default: (0, u.w5)(() => [f]), _: 1 }
              ),
              (0, u.Wm)(d)
            ])
          );
        }
        var d = (0, u.aZ)({ name: "App", components: {} }),
          p = n(89);
        const m = (0, p.Z)(d, [["render", l]]);
        var v = m,
          h = n(678);
        const g = [
            { path: "/", redirect: "/login" },
            { path: "/login", component: () => n.e(617).then(n.bind(n, 5617)) },
            { path: "/main", component: () => n.e(38).then(n.bind(n, 1038)) }
          ],
          b = (0, h.p7)({ routes: g, history: (0, h.r5)() });
        var y = b,
          w = n(65);
        const k = (0, w.MT)({
          state: () => ({ name: "acwink" }),
  ...
  (n.m = e),
    ...
    (function () {
      n.u = function (e) {
        return "js/" + e + "." + { 38: "c700ebe8", 617: "2b8ffb66" }[e] + ".js";
      };
    })(),
    (function () {
      n.miniCssF = function (e) {
        return "css/" + e + ".6b656077.css";
      };
    })(),
    (function () {
      n.g = (function () {
...
//# sourceMappingURL=app.509bede7.js.map
